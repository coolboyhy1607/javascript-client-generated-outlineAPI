...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FileOperation', function() {
      beforeEach(function() {
        instance = new OutlineApi.FileOperation();
      });

      it('should create an instance of FileOperation', function() {
        // TODO: update the code to test FileOperation
        expect(instance).to.be.a(OutlineApi.FileOperation);
      });
