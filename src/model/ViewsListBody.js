...
/**
 * The ViewsListBody model module.
 * @module model/ViewsListBody
 * @version 0.1.0
 */
export class ViewsListBody {
  /**
   * Constructs a new <code>ViewsListBody</code>.
   * @alias module:model/ViewsListBody
   * @class
  ...
  /**
   * Constructs a <code>ViewsListBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ViewsListBody} obj Optional instance to populate.
   * @return {module:model/ViewsListBody} The populated <code>ViewsListBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ViewsListBody();
 ...
 */
ViewsListBody.prototype.documentId = undefined;
