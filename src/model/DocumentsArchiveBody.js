...
/**
 * The DocumentsArchiveBody model module.
 * @module model/DocumentsArchiveBody
 * @version 0.1.0
 */
export class DocumentsArchiveBody {
  /**
   * Constructs a new <code>DocumentsArchiveBody</code>.
   * @alias module:model/DocumentsArchiveBody
   * @class
  ...
  /**
   * Constructs a <code>DocumentsArchiveBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocumentsArchiveBody} obj Optional instance to populate.
   * @return {module:model/DocumentsArchiveBody} The populated <code>DocumentsArchiveBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DocumentsArchiveBody();
 ...
 * @member {String} id
 */
DocumentsArchiveBody.prototype.id = undefined;
