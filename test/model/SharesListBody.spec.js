...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SharesListBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.SharesListBody();
      });

      it('should create an instance of SharesListBody', function() {
        // TODO: update the code to test SharesListBody
        expect(instance).to.be.a(OutlineApi.SharesListBody);
      });
