...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SharesInfoBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.SharesInfoBody();
      });

      it('should create an instance of SharesInfoBody', function() {
        // TODO: update the code to test SharesInfoBody
        expect(instance).to.be.a(OutlineApi.SharesInfoBody);
      });
