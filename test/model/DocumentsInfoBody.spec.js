...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentsInfoBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.DocumentsInfoBody();
      });

      it('should create an instance of DocumentsInfoBody', function() {
        // TODO: update the code to test DocumentsInfoBody
        expect(instance).to.be.a(OutlineApi.DocumentsInfoBody);
      });
