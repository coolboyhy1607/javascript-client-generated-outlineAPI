...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OutlineApi.AuthApi();
  });

  describe('(package)', function() {
    describe('AuthApi', function() {
      describe('authConfigPost', function() {
        it('should call authConfigPost successfully', function(done) {
          // TODO: uncomment authConfigPost call and complete the assertions
          /*

          instance.authConfigPost(function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(OutlineApi.InlineResponse2003);
      ...
      describe('authInfoPost', function() {
        it('should call authInfoPost successfully', function(done) {
          // TODO: uncomment authInfoPost call and complete the assertions
          /*

          instance.authInfoPost(function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(OutlineApi.InlineResponse2002);
