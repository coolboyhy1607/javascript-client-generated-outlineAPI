...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentsStarredBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.DocumentsStarredBody();
      });

      it('should create an instance of DocumentsStarredBody', function() {
        // TODO: update the code to test DocumentsStarredBody
        expect(instance).to.be.a(OutlineApi.DocumentsStarredBody);
      });
