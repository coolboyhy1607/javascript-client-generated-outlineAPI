...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentsDraftsBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.DocumentsDraftsBody();
      });

      it('should create an instance of DocumentsDraftsBody', function() {
        // TODO: update the code to test DocumentsDraftsBody
        expect(instance).to.be.a(OutlineApi.DocumentsDraftsBody);
      });
