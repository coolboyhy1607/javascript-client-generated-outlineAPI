...
/**
 * The DocumentsPinBody model module.
 * @module model/DocumentsPinBody
 * @version 0.1.0
 */
export class DocumentsPinBody {
  /**
   * Constructs a new <code>DocumentsPinBody</code>.
   * @alias module:model/DocumentsPinBody
   * @class
  ...
  /**
   * Constructs a <code>DocumentsPinBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocumentsPinBody} obj Optional instance to populate.
   * @return {module:model/DocumentsPinBody} The populated <code>DocumentsPinBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DocumentsPinBody();
 ...
 * @member {String} id
 */
DocumentsPinBody.prototype.id = undefined;
