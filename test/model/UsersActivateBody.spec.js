...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UsersActivateBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.UsersActivateBody();
      });

      it('should create an instance of UsersActivateBody', function() {
        // TODO: update the code to test UsersActivateBody
        expect(instance).to.be.a(OutlineApi.UsersActivateBody);
      });
