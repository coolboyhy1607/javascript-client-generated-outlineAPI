...
/**
 * The DocumentsImportBody model module.
 * @module model/DocumentsImportBody
 * @version 0.1.0
 */
export class DocumentsImportBody {
  /**
   * Constructs a new <code>DocumentsImportBody</code>.
   * @alias module:model/DocumentsImportBody
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>DocumentsImportBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocumentsImportBody} obj Optional instance to populate.
   * @return {module:model/DocumentsImportBody} The populated <code>DocumentsImportBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DocumentsImportBody();
 ...
 * @member {Object} file
 */
DocumentsImportBody.prototype.file = undefined;

/**
 * @member {String} collectionId
 */
DocumentsImportBody.prototype.collectionId = undefined;

/**
 * @member {String} parentDocumentId
 */
DocumentsImportBody.prototype.parentDocumentId = undefined;

/**
 * @member {Boolean} template
 */
DocumentsImportBody.prototype.template = undefined;

/**
 * @member {Boolean} publish
 */
DocumentsImportBody.prototype.publish = undefined;
