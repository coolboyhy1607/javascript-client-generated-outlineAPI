...
export class InlineResponse20011Data {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('fileOperation'))
        obj.fileOperation = FileOperation.constructFromObject(data['fileOperation']);
    }
    return obj;
  }
}
...
/**
 * @member {module:model/FileOperation} fileOperation
 */
InlineResponse20011Data.prototype.fileOperation = undefined;
