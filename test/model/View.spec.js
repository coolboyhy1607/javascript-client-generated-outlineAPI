...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('View', function() {
      ...
      it('should have the property firstViewedAt (base name: "firstViewedAt")', function() {
        // TODO: update the code to test the property firstViewedAt
        expect(instance).to.have.property('firstViewedAt');
        // expect(instance.firstViewedAt).to.be(expectedValueLiteral);
      });

      it('should have the property lastViewedAt (base name: "lastViewedAt")', function() {
        // TODO: update the code to test the property lastViewedAt
        expect(instance).to.have.property('lastViewedAt');
        // expect(instance.lastViewedAt).to.be(expectedValueLiteral);
      });
