...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentsListBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.DocumentsListBody();
      });

      it('should create an instance of DocumentsListBody', function() {
        // TODO: update the code to test DocumentsListBody
        expect(instance).to.be.a(OutlineApi.DocumentsListBody);
      });
      ...
      it('should have the property backlinkDocumentId (base name: "backlinkDocumentId")', function() {
        // TODO: update the code to test the property backlinkDocumentId
        expect(instance).to.have.property('backlinkDocumentId');
        // expect(instance.backlinkDocumentId).to.be(expectedValueLiteral);
      });
