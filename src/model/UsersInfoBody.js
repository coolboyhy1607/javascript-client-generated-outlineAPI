...
/**
 * The UsersInfoBody model module.
 * @module model/UsersInfoBody
 * @version 0.1.0
 */
export class UsersInfoBody {
  /**
   * Constructs a new <code>UsersInfoBody</code>.
   * @alias module:model/UsersInfoBody
   * @class
  ...
  /**
   * Constructs a <code>UsersInfoBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UsersInfoBody} obj Optional instance to populate.
   * @return {module:model/UsersInfoBody} The populated <code>UsersInfoBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new UsersInfoBody();
 ...
 * @member {String} id
 */
UsersInfoBody.prototype.id = undefined;
