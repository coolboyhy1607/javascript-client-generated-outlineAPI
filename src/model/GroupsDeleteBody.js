...
/**
 * The GroupsDeleteBody model module.
 * @module model/GroupsDeleteBody
 * @version 0.1.0
 */
export class GroupsDeleteBody {
  /**
   * Constructs a new <code>GroupsDeleteBody</code>.
   * @alias module:model/GroupsDeleteBody
   * @class
   * @param id {String} 
   */
  constructor(id) {
  ...
  /**
   * Constructs a <code>GroupsDeleteBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GroupsDeleteBody} obj Optional instance to populate.
   * @return {module:model/GroupsDeleteBody} The populated <code>GroupsDeleteBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new GroupsDeleteBody();
 ...
 * @member {String} id
 */
GroupsDeleteBody.prototype.id = undefined;
