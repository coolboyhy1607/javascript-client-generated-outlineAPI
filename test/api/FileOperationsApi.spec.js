...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OutlineApi.FileOperationsApi();
  });

  describe('(package)', function() {
    describe('FileOperationsApi', function() {
      describe('fileOperationsInfoPost', function() {
        it('should call fileOperationsInfoPost successfully', function(done) {
          // TODO: uncomment, update parameter values for fileOperationsInfoPost call and complete the assertions
          /*
          var opts = {};

          instance.fileOperationsInfoPost(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(OutlineApi.InlineResponse20020);
      ...
      describe('fileOperationsListPost', function() {
        it('should call fileOperationsListPost successfully', function(done) {
          // TODO: uncomment, update parameter values for fileOperationsListPost call and complete the assertions
          /*
          var opts = {};

          instance.fileOperationsListPost(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(OutlineApi.InlineResponse20021);
      ...
      describe('fileOperationsRedirectPost', function() {
        it('should call fileOperationsRedirectPost successfully', function(done) {
          // TODO: uncomment, update parameter values for fileOperationsRedirectPost call and complete the assertions
          /*
          var opts = {};

          instance.fileOperationsRedirectPost(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
