...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ViewsCreateBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.ViewsCreateBody();
      });

      it('should create an instance of ViewsCreateBody', function() {
        // TODO: update the code to test ViewsCreateBody
        expect(instance).to.be.a(OutlineApi.ViewsCreateBody);
      });
