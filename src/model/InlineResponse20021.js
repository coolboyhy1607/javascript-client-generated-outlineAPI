  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = ApiClient.convertToType(data['data'], [FileOperation]);
...
/**
 * @member {Array.<module:model/FileOperation>} data
 */
 ...
 */
InlineResponse20021.prototype.pagination = undefined;
