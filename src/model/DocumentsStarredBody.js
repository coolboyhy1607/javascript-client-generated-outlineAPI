...
/**
 * The DocumentsStarredBody model module.
 * @module model/DocumentsStarredBody
 * @version 0.1.0
 */
export class DocumentsStarredBody extends Pagination {
  /**
   * Constructs a new <code>DocumentsStarredBody</code>.
   * @alias module:model/DocumentsStarredBody
   * @class
  ...
  /**
   * Constructs a <code>DocumentsStarredBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocumentsStarredBody} obj Optional instance to populate.
   * @return {module:model/DocumentsStarredBody} The populated <code>DocumentsStarredBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DocumentsStarredBody();
 ...
 * @member {String} sort
 */
DocumentsStarredBody.prototype.sort = undefined;
 ...
 * @readonly
 */
DocumentsStarredBody.DirectionEnum = {
  /**
   * value: "ASC"
   * @const
   */
...
/**
 * @member {module:model/DocumentsStarredBody.DirectionEnum} direction
 */
DocumentsStarredBody.prototype.direction = undefined;
