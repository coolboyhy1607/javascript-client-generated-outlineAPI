...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20026Data', function() {
      beforeEach(function() {
        instance = new OutlineApi.InlineResponse20026Data();
      });

      it('should create an instance of InlineResponse20026Data', function() {
        // TODO: update the code to test InlineResponse20026Data
        expect(instance).to.be.a(OutlineApi.InlineResponse20026Data);
      });
      ...
      it('should have the property groupMemberships (base name: "groupMemberships")', function() {
        // TODO: update the code to test the property groupMemberships
        expect(instance).to.have.property('groupMemberships');
        // expect(instance.groupMemberships).to.be(expectedValueLiteral);
      });
