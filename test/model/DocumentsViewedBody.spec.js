...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentsViewedBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.DocumentsViewedBody();
      });

      it('should create an instance of DocumentsViewedBody', function() {
        // TODO: update the code to test DocumentsViewedBody
        expect(instance).to.be.a(OutlineApi.DocumentsViewedBody);
      });
