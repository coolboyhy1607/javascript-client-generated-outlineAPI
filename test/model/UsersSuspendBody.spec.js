...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UsersSuspendBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.UsersSuspendBody();
      });

      it('should create an instance of UsersSuspendBody', function() {
        // TODO: update the code to test UsersSuspendBody
        expect(instance).to.be.a(OutlineApi.UsersSuspendBody);
      });
