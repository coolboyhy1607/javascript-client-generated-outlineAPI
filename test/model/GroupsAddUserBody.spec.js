...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GroupsAddUserBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.GroupsAddUserBody();
      });

      it('should create an instance of GroupsAddUserBody', function() {
        // TODO: update the code to test GroupsAddUserBody
        expect(instance).to.be.a(OutlineApi.GroupsAddUserBody);
      });
