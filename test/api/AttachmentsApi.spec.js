...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OutlineApi.AttachmentsApi();
  });

  describe('(package)', function() {
    describe('AttachmentsApi', function() {
      describe('attachmentsCreatePost', function() {
        it('should call attachmentsCreatePost successfully', function(done) {
          // TODO: uncomment, update parameter values for attachmentsCreatePost call and complete the assertions
          /*
          var opts = {};

          instance.attachmentsCreatePost(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(OutlineApi.InlineResponse200);
      ...
      describe('attachmentsDeletePost', function() {
        it('should call attachmentsDeletePost successfully', function(done) {
          // TODO: uncomment, update parameter values for attachmentsDeletePost call and complete the assertions
          /*
          var opts = {};

          instance.attachmentsDeletePost(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('attachmentsRedirectPost', function() {
        it('should call attachmentsRedirectPost successfully', function(done) {
          // TODO: uncomment, update parameter values for attachmentsRedirectPost call
          /*
          var opts = {};

          instance.attachmentsRedirectPost(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
