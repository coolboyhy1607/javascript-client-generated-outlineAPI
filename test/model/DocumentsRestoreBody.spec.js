...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentsRestoreBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.DocumentsRestoreBody();
      });

      it('should create an instance of DocumentsRestoreBody', function() {
        // TODO: update the code to test DocumentsRestoreBody
        expect(instance).to.be.a(OutlineApi.DocumentsRestoreBody);
      });
      ...
      it('should have the property revisionId (base name: "revisionId")', function() {
        // TODO: update the code to test the property revisionId
        expect(instance).to.have.property('revisionId');
        // expect(instance.revisionId).to.be(expectedValueLiteral);
      });
