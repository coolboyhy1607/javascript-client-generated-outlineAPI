...
/**
 * The UsersSuspendBody model module.
 * @module model/UsersSuspendBody
 * @version 0.1.0
 */
export class UsersSuspendBody {
  /**
   * Constructs a new <code>UsersSuspendBody</code>.
   * @alias module:model/UsersSuspendBody
   * @class
  ...
  /**
   * Constructs a <code>UsersSuspendBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UsersSuspendBody} obj Optional instance to populate.
   * @return {module:model/UsersSuspendBody} The populated <code>UsersSuspendBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new UsersSuspendBody();
 ...
 * @member {String} id
 */
UsersSuspendBody.prototype.id = undefined;
