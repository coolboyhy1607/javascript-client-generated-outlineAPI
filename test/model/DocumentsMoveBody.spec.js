...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentsMoveBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.DocumentsMoveBody();
      });

      it('should create an instance of DocumentsMoveBody', function() {
        // TODO: update the code to test DocumentsMoveBody
        expect(instance).to.be.a(OutlineApi.DocumentsMoveBody);
      });
