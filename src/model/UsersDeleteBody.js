...
/**
 * The UsersDeleteBody model module.
 * @module model/UsersDeleteBody
 * @version 0.1.0
 */
export class UsersDeleteBody {
  /**
   * Constructs a new <code>UsersDeleteBody</code>.
   * @alias module:model/UsersDeleteBody
   * @class
  ...
  /**
   * Constructs a <code>UsersDeleteBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UsersDeleteBody} obj Optional instance to populate.
   * @return {module:model/UsersDeleteBody} The populated <code>UsersDeleteBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new UsersDeleteBody();
 ...
 * @member {String} id
 */
UsersDeleteBody.prototype.id = undefined;
