...
/**
 * The UsersUpdateBody model module.
 * @module model/UsersUpdateBody
 * @version 0.1.0
 */
export class UsersUpdateBody {
  /**
   * Constructs a new <code>UsersUpdateBody</code>.
   * @alias module:model/UsersUpdateBody
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>UsersUpdateBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UsersUpdateBody} obj Optional instance to populate.
   * @return {module:model/UsersUpdateBody} The populated <code>UsersUpdateBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new UsersUpdateBody();
 ...
 * @member {String} name
 */
UsersUpdateBody.prototype.name = undefined;

/**
 * @member {String} avatarUrl
 */
UsersUpdateBody.prototype.avatarUrl = undefined;
