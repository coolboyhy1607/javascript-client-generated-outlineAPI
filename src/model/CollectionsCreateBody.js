...
/**
 * The CollectionsCreateBody model module.
 * @module model/CollectionsCreateBody
 * @version 0.1.0
 */
export class CollectionsCreateBody {
  /**
   * Constructs a new <code>CollectionsCreateBody</code>.
   * @alias module:model/CollectionsCreateBody
   * @class
   * @param name {String} 
   */
  constructor(name) {
  ...
  /**
   * Constructs a <code>CollectionsCreateBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CollectionsCreateBody} obj Optional instance to populate.
   * @return {module:model/CollectionsCreateBody} The populated <code>CollectionsCreateBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CollectionsCreateBody();
 ...
 * @member {String} name
 */
CollectionsCreateBody.prototype.name = undefined;

/**
 * @member {String} description
 */
CollectionsCreateBody.prototype.description = undefined;

/**
 * @member {String} color
 */
CollectionsCreateBody.prototype.color = undefined;

/**
 * @member {Boolean} _private
 */
CollectionsCreateBody.prototype._private = undefined;
