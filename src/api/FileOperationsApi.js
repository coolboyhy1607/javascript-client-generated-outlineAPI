...
* @module api/FileOperationsApi
* @version 0.1.0
*/
export class FileOperationsApi {

    /**
    * Constructs a new FileOperationsApi. 
    * @alias module:api/FileOperationsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the fileOperationsInfoPost operation.
     * @callback moduleapi/FileOperationsApi~fileOperationsInfoPostCallback
     ...
     * @param {module:model/FileOperationsInfoBody} opts.body 
     * @param {module:api/FileOperationsApi~fileOperationsInfoPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    fileOperationsInfoPost(opts, callback) {
      opts = opts || {};
    ...
    /**
     * Callback function to receive the result of the fileOperationsListPost operation.
     * @callback moduleapi/FileOperationsApi~fileOperationsListPostCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/FileOperationsListBody} opts.body 
     * @param {module:api/FileOperationsApi~fileOperationsListPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    fileOperationsListPost(opts, callback) {
      opts = opts || {};
      let postBody = opts['body'];
    ...
    /**
     * Callback function to receive the result of the fileOperationsRedirectPost operation.
     * @callback moduleapi/FileOperationsApi~fileOperationsRedirectPostCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/FileOperationsRedirectBody} opts.body 
     * @param {module:api/FileOperationsApi~fileOperationsRedirectPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    fileOperationsRedirectPost(opts, callback) {
      opts = opts || {};
      let postBody = opts['body'];
