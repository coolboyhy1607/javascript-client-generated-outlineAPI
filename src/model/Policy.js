...
import {PolicyAbilities} from './PolicyAbilities';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('abilities'))
        obj.abilities = PolicyAbilities.constructFromObject(data['abilities']);
    }
    return obj;
  }
}
...
/**
 * @member {module:model/PolicyAbilities} abilities
 */
Policy.prototype.abilities = undefined;
