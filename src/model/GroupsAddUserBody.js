...
/**
 * The GroupsAddUserBody model module.
 * @module model/GroupsAddUserBody
 * @version 0.1.0
 */
export class GroupsAddUserBody {
  /**
   * Constructs a new <code>GroupsAddUserBody</code>.
   * @alias module:model/GroupsAddUserBody
   * @class
   * @param id {String} 
   * @param userId {String} 
   */
  ...
  /**
   * Constructs a <code>GroupsAddUserBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GroupsAddUserBody} obj Optional instance to populate.
   * @return {module:model/GroupsAddUserBody} The populated <code>GroupsAddUserBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new GroupsAddUserBody();
 ...
 * @member {String} id
 */
GroupsAddUserBody.prototype.id = undefined;

/**
 * @member {String} userId
 */
GroupsAddUserBody.prototype.userId = undefined;
