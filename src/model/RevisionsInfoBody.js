...
/**
 * The RevisionsInfoBody model module.
 * @module model/RevisionsInfoBody
 * @version 0.1.0
 */
export class RevisionsInfoBody {
  /**
   * Constructs a new <code>RevisionsInfoBody</code>.
   * @alias module:model/RevisionsInfoBody
   * @class
   * @param id {String} Unique identifier for the revision.
   */
  constructor(id) {
    this.id = id;
  }
  ...
  /**
   * Constructs a <code>RevisionsInfoBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RevisionsInfoBody} obj Optional instance to populate.
   * @return {module:model/RevisionsInfoBody} The populated <code>RevisionsInfoBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new RevisionsInfoBody();
 ...
 * @member {String} id
 */
RevisionsInfoBody.prototype.id = undefined;
