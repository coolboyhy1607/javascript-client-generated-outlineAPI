...
/**
 * The DocumentsPinnedBody model module.
 * @module model/DocumentsPinnedBody
 * @version 0.1.0
 */
export class DocumentsPinnedBody extends Pagination {
  /**
   * Constructs a new <code>DocumentsPinnedBody</code>.
   * @alias module:model/DocumentsPinnedBody
   * @class
  ...
  /**
   * Constructs a <code>DocumentsPinnedBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocumentsPinnedBody} obj Optional instance to populate.
   * @return {module:model/DocumentsPinnedBody} The populated <code>DocumentsPinnedBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DocumentsPinnedBody();
 ...
 * @member {String} sort
 */
DocumentsPinnedBody.prototype.sort = undefined;
 ...
 * @readonly
 */
DocumentsPinnedBody.DirectionEnum = {
  /**
   * value: "ASC"
   * @const
   */
...
/**
 * @member {module:model/DocumentsPinnedBody.DirectionEnum} direction
 */
DocumentsPinnedBody.prototype.direction = undefined;

/**
 * @member {String} collectionId
 */
DocumentsPinnedBody.prototype.collectionId = undefined;
