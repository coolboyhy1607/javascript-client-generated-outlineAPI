...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentsDeleteBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.DocumentsDeleteBody();
      });

      it('should create an instance of DocumentsDeleteBody', function() {
        // TODO: update the code to test DocumentsDeleteBody
        expect(instance).to.be.a(OutlineApi.DocumentsDeleteBody);
      });
      ...
      it('should have the property permanent (base name: "permanent")', function() {
        // TODO: update the code to test the property permanent
        expect(instance).to.have.property('permanent');
        // expect(instance.permanent).to.be(expectedValueLiteral);
      });
