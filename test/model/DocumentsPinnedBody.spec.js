...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentsPinnedBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.DocumentsPinnedBody();
      });

      it('should create an instance of DocumentsPinnedBody', function() {
        // TODO: update the code to test DocumentsPinnedBody
        expect(instance).to.be.a(OutlineApi.DocumentsPinnedBody);
      });
