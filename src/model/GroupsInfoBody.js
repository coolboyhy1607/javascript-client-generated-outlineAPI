...
/**
 * The GroupsInfoBody model module.
 * @module model/GroupsInfoBody
 * @version 0.1.0
 */
export class GroupsInfoBody {
  /**
   * Constructs a new <code>GroupsInfoBody</code>.
   * @alias module:model/GroupsInfoBody
   * @class
  ...
  /**
   * Constructs a <code>GroupsInfoBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GroupsInfoBody} obj Optional instance to populate.
   * @return {module:model/GroupsInfoBody} The populated <code>GroupsInfoBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new GroupsInfoBody();
 ...
 * @member {String} id
 */
GroupsInfoBody.prototype.id = undefined;
