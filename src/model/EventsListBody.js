...
/**
 * The EventsListBody model module.
 * @module model/EventsListBody
 * @version 0.1.0
 */
export class EventsListBody extends Pagination {
  /**
   * Constructs a new <code>EventsListBody</code>.
   * @alias module:model/EventsListBody
   * @class
  ...
  /**
   * Constructs a <code>EventsListBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EventsListBody} obj Optional instance to populate.
   * @return {module:model/EventsListBody} The populated <code>EventsListBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new EventsListBody();
      ...
      if (data.hasOwnProperty('auditLog'))
        obj.auditLog = ApiClient.convertToType(data['auditLog'], 'Boolean');
    }
    return obj;
  }
}
 ...
 * @member {String} sort
 */
EventsListBody.prototype.sort = undefined;
