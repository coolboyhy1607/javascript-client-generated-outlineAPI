...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfFileOperationCollection', function() {
      beforeEach(function() {
        instance = new OutlineApi.AllOfFileOperationCollection();
      });

      it('should create an instance of AllOfFileOperationCollection', function() {
        // TODO: update the code to test AllOfFileOperationCollection
        expect(instance).to.be.a(OutlineApi.AllOfFileOperationCollection);
      });
