...
/**
 * The CollectionsExportBody model module.
 * @module model/CollectionsExportBody
 * @version 0.1.0
 */
export class CollectionsExportBody {
  /**
   * Constructs a new <code>CollectionsExportBody</code>.
   * @alias module:model/CollectionsExportBody
   * @class
   * @param id {String} 
   */
  constructor(id) {
  ...
  /**
   * Constructs a <code>CollectionsExportBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CollectionsExportBody} obj Optional instance to populate.
   * @return {module:model/CollectionsExportBody} The populated <code>CollectionsExportBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CollectionsExportBody();
 ...
 * @member {String} id
 */
CollectionsExportBody.prototype.id = undefined;
