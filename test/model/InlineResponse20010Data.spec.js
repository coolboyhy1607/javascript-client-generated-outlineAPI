...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20010Data', function() {
      ...
      it('should have the property collectionGroupMemberships (base name: "collectionGroupMemberships")', function() {
        // TODO: update the code to test the property collectionGroupMemberships
        expect(instance).to.have.property('collectionGroupMemberships');
        // expect(instance.collectionGroupMemberships).to.be(expectedValueLiteral);
      });
