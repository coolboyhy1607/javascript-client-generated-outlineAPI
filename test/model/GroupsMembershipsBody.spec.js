...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GroupsMembershipsBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.GroupsMembershipsBody();
      });

      it('should create an instance of GroupsMembershipsBody', function() {
        // TODO: update the code to test GroupsMembershipsBody
        expect(instance).to.be.a(OutlineApi.GroupsMembershipsBody);
      });
