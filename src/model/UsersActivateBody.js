...
/**
 * The UsersActivateBody model module.
 * @module model/UsersActivateBody
 * @version 0.1.0
 */
export class UsersActivateBody {
  /**
   * Constructs a new <code>UsersActivateBody</code>.
   * @alias module:model/UsersActivateBody
   * @class
  ...
  /**
   * Constructs a <code>UsersActivateBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UsersActivateBody} obj Optional instance to populate.
   * @return {module:model/UsersActivateBody} The populated <code>UsersActivateBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new UsersActivateBody();
 ...
 * @member {String} id
 */
UsersActivateBody.prototype.id = undefined;
