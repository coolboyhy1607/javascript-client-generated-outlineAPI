...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UsersDeleteBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.UsersDeleteBody();
      });

      it('should create an instance of UsersDeleteBody', function() {
        // TODO: update the code to test UsersDeleteBody
        expect(instance).to.be.a(OutlineApi.UsersDeleteBody);
      });
