...
/**
 * The SharesCreateBody model module.
 * @module model/SharesCreateBody
 * @version 0.1.0
 */
export class SharesCreateBody {
  /**
   * Constructs a new <code>SharesCreateBody</code>.
   * @alias module:model/SharesCreateBody
   * @class
  ...
  /**
   * Constructs a <code>SharesCreateBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SharesCreateBody} obj Optional instance to populate.
   * @return {module:model/SharesCreateBody} The populated <code>SharesCreateBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new SharesCreateBody();
 ...
 */
SharesCreateBody.prototype.documentId = undefined;
