...
/**
 * The DocumentsDraftsBody model module.
 * @module model/DocumentsDraftsBody
 * @version 0.1.0
 */
export class DocumentsDraftsBody extends Pagination {
  /**
   * Constructs a new <code>DocumentsDraftsBody</code>.
   * @alias module:model/DocumentsDraftsBody
   * @class
  ...
  /**
   * Constructs a <code>DocumentsDraftsBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocumentsDraftsBody} obj Optional instance to populate.
   * @return {module:model/DocumentsDraftsBody} The populated <code>DocumentsDraftsBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DocumentsDraftsBody();
 ...
 * @member {String} sort
 */
DocumentsDraftsBody.prototype.sort = undefined;
 ...
 * @readonly
 */
DocumentsDraftsBody.DirectionEnum = {
  /**
   * value: "ASC"
   * @const
   */
...
/**
 * @member {module:model/DocumentsDraftsBody.DirectionEnum} direction
 */
DocumentsDraftsBody.prototype.direction = undefined;

/**
 * A collection to search within
 * @member {String} collectionId
 */
DocumentsDraftsBody.prototype.collectionId = undefined;
 ...
 * @readonly
 */
DocumentsDraftsBody.DateFilterEnum = {
  /**
   * value: "day"
   * @const
   */
 ...
 * @member {module:model/DocumentsDraftsBody.DateFilterEnum} dateFilter
 */
DocumentsDraftsBody.prototype.dateFilter = undefined;
