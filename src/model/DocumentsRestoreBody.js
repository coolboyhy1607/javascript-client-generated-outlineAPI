...
/**
 * The DocumentsRestoreBody model module.
 * @module model/DocumentsRestoreBody
 * @version 0.1.0
 */
export class DocumentsRestoreBody {
  /**
   * Constructs a new <code>DocumentsRestoreBody</code>.
   * @alias module:model/DocumentsRestoreBody
   * @class
  ...
  /**
   * Constructs a <code>DocumentsRestoreBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocumentsRestoreBody} obj Optional instance to populate.
   * @return {module:model/DocumentsRestoreBody} The populated <code>DocumentsRestoreBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DocumentsRestoreBody();
 ...
 * @member {String} id
 */
DocumentsRestoreBody.prototype.id = undefined;

/**
 * Identifier for the revision to restore to.
 * @member {String} revisionId
 */
DocumentsRestoreBody.prototype.revisionId = undefined;
