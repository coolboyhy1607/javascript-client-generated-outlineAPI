...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FileOperationsInfoBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.FileOperationsInfoBody();
      });

      it('should create an instance of FileOperationsInfoBody', function() {
        // TODO: update the code to test FileOperationsInfoBody
        expect(instance).to.be.a(OutlineApi.FileOperationsInfoBody);
      });
