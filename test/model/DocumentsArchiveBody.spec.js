...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentsArchiveBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.DocumentsArchiveBody();
      });

      it('should create an instance of DocumentsArchiveBody', function() {
        // TODO: update the code to test DocumentsArchiveBody
        expect(instance).to.be.a(OutlineApi.DocumentsArchiveBody);
      });
