...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ViewsListBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.ViewsListBody();
      });

      it('should create an instance of ViewsListBody', function() {
        // TODO: update the code to test ViewsListBody
        expect(instance).to.be.a(OutlineApi.ViewsListBody);
      });
