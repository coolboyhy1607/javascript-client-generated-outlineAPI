 ...
 * @module model/Sorting
 * @version 0.1.0
 */
export class Sorting {
  /**
   * Constructs a new <code>Sorting</code>.
   * @alias module:model/Sorting
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:model/Sorting} obj Optional instance to populate.
   * @return {module:model/Sorting} The populated <code>Sorting</code> instance.
   */
 ...
 * @member {String} sort
 */
Sorting.prototype.sort = undefined;
...
/**
 * @member {module:model/Sorting.DirectionEnum} direction
 */
Sorting.prototype.direction = undefined;
