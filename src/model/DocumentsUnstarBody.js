...
/**
 * The DocumentsUnstarBody model module.
 * @module model/DocumentsUnstarBody
 * @version 0.1.0
 */
export class DocumentsUnstarBody {
  /**
   * Constructs a new <code>DocumentsUnstarBody</code>.
   * @alias module:model/DocumentsUnstarBody
   * @class
  ...
  /**
   * Constructs a <code>DocumentsUnstarBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocumentsUnstarBody} obj Optional instance to populate.
   * @return {module:model/DocumentsUnstarBody} The populated <code>DocumentsUnstarBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DocumentsUnstarBody();
 ...
 * @member {String} id
 */
DocumentsUnstarBody.prototype.id = undefined;
