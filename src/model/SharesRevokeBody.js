...
/**
 * The SharesRevokeBody model module.
 * @module model/SharesRevokeBody
 * @version 0.1.0
 */
export class SharesRevokeBody {
  /**
   * Constructs a new <code>SharesRevokeBody</code>.
   * @alias module:model/SharesRevokeBody
   * @class
   * @param id {String} 
   */
  constructor(id) {
  ...
  /**
   * Constructs a <code>SharesRevokeBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SharesRevokeBody} obj Optional instance to populate.
   * @return {module:model/SharesRevokeBody} The populated <code>SharesRevokeBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new SharesRevokeBody();
 ...
 * @member {String} id
 */
SharesRevokeBody.prototype.id = undefined;
