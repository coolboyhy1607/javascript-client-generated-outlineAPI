...
/**
 * The GroupsCreateBody model module.
 * @module model/GroupsCreateBody
 * @version 0.1.0
 */
export class GroupsCreateBody {
  /**
   * Constructs a new <code>GroupsCreateBody</code>.
   * @alias module:model/GroupsCreateBody
   * @class
   * @param name {String} 
   */
  constructor(name) {
  ...
  /**
   * Constructs a <code>GroupsCreateBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GroupsCreateBody} obj Optional instance to populate.
   * @return {module:model/GroupsCreateBody} The populated <code>GroupsCreateBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new GroupsCreateBody();
 ...
 * @member {String} name
 */
GroupsCreateBody.prototype.name = undefined;
