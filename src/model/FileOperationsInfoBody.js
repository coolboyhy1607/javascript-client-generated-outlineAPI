...
/**
 * The FileOperationsInfoBody model module.
 * @module model/FileOperationsInfoBody
 * @version 0.1.0
 */
export class FileOperationsInfoBody {
  /**
   * Constructs a new <code>FileOperationsInfoBody</code>.
   * @alias module:model/FileOperationsInfoBody
   * @class
  ...
  /**
   * Constructs a <code>FileOperationsInfoBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FileOperationsInfoBody} obj Optional instance to populate.
   * @return {module:model/FileOperationsInfoBody} The populated <code>FileOperationsInfoBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new FileOperationsInfoBody();
 ...
 * @member {String} id
 */
FileOperationsInfoBody.prototype.id = undefined;
