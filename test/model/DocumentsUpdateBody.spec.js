...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentsUpdateBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.DocumentsUpdateBody();
      });

      it('should create an instance of DocumentsUpdateBody', function() {
        // TODO: update the code to test DocumentsUpdateBody
        expect(instance).to.be.a(OutlineApi.DocumentsUpdateBody);
      });
      ...
      it('should have the property append (base name: "append")', function() {
        // TODO: update the code to test the property append
        expect(instance).to.have.property('append');
        // expect(instance.append).to.be(expectedValueLiteral);
      });
