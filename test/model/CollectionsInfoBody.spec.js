...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CollectionsInfoBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.CollectionsInfoBody();
      });

      it('should create an instance of CollectionsInfoBody', function() {
        // TODO: update the code to test CollectionsInfoBody
        expect(instance).to.be.a(OutlineApi.CollectionsInfoBody);
      });
