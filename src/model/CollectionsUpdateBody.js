...
/**
 * The CollectionsUpdateBody model module.
 * @module model/CollectionsUpdateBody
 * @version 0.1.0
 */
export class CollectionsUpdateBody {
  /**
   * Constructs a new <code>CollectionsUpdateBody</code>.
   * @alias module:model/CollectionsUpdateBody
   * @class
   * @param id {String} 
   */
  constructor(id) {
  ...
  /**
   * Constructs a <code>CollectionsUpdateBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CollectionsUpdateBody} obj Optional instance to populate.
   * @return {module:model/CollectionsUpdateBody} The populated <code>CollectionsUpdateBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CollectionsUpdateBody();
 ...
 * @member {String} id
 */
CollectionsUpdateBody.prototype.id = undefined;

/**
 * @member {String} name
 */
CollectionsUpdateBody.prototype.name = undefined;

/**
 * @member {String} description
 */
CollectionsUpdateBody.prototype.description = undefined;

/**
 * @member {String} color
 */
CollectionsUpdateBody.prototype.color = undefined;
