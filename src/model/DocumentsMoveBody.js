...
/**
 * The DocumentsMoveBody model module.
 * @module model/DocumentsMoveBody
 * @version 0.1.0
 */
export class DocumentsMoveBody {
  /**
   * Constructs a new <code>DocumentsMoveBody</code>.
   * @alias module:model/DocumentsMoveBody
   * @class
  ...
  /**
   * Constructs a <code>DocumentsMoveBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocumentsMoveBody} obj Optional instance to populate.
   * @return {module:model/DocumentsMoveBody} The populated <code>DocumentsMoveBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DocumentsMoveBody();
 ...
 * @member {String} id
 */
DocumentsMoveBody.prototype.id = undefined;

/**
 * @member {String} collectionId
 */
DocumentsMoveBody.prototype.collectionId = undefined;

/**
 * @member {String} parentDocumentId
 */
DocumentsMoveBody.prototype.parentDocumentId = undefined;
