...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EventsListBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.EventsListBody();
      });

      it('should create an instance of EventsListBody', function() {
        // TODO: update the code to test EventsListBody
        expect(instance).to.be.a(OutlineApi.EventsListBody);
      });
      ...
      it('should have the property actorId (base name: "actorId")', function() {
        // TODO: update the code to test the property actorId
        expect(instance).to.have.property('actorId');
        // expect(instance.actorId).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property auditLog (base name: "auditLog")', function() {
        // TODO: update the code to test the property auditLog
        expect(instance).to.have.property('auditLog');
        // expect(instance.auditLog).to.be(expectedValueLiteral);
      });
