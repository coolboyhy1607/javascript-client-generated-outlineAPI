...
export class InlineResponse20010Data {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('collectionGroupMemberships'))
        obj.collectionGroupMemberships = ApiClient.convertToType(data['collectionGroupMemberships'], [CollectionGroupMembership]);
    }
    return obj;
  }
}
 ...
 */
InlineResponse20010Data.prototype.groups = undefined;

/**
 * @member {Array.<module:model/CollectionGroupMembership>} collectionGroupMemberships
 */
InlineResponse20010Data.prototype.collectionGroupMemberships = undefined;
