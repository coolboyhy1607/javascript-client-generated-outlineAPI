...
export class View {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('firstViewedAt'))
        obj.firstViewedAt = ApiClient.convertToType(data['firstViewedAt'], 'Date');
      if (data.hasOwnProperty('lastViewedAt'))
        obj.lastViewedAt = ApiClient.convertToType(data['lastViewedAt'], 'Date');
 ...
 */
View.prototype.documentId = undefined;

/**
 * When the document was first viewed by the user
 * @member {Date} firstViewedAt
 */
View.prototype.firstViewedAt = undefined;

/**
 * When the document was last viewed by the user
 * @member {Date} lastViewedAt
 */
View.prototype.lastViewedAt = undefined;

/**
 * The number of times the user has viewed the document.
 * @member {Number} count
 */
View.prototype.count = undefined;

/**
 * @member {module:model/User} user
 */
View.prototype.user = undefined;
