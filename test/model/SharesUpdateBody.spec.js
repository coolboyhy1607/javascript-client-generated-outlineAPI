...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SharesUpdateBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.SharesUpdateBody();
      });

      it('should create an instance of SharesUpdateBody', function() {
        // TODO: update the code to test SharesUpdateBody
        expect(instance).to.be.a(OutlineApi.SharesUpdateBody);
      });
