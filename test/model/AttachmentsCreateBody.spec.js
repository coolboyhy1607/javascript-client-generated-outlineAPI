...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AttachmentsCreateBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.AttachmentsCreateBody();
      });

      it('should create an instance of AttachmentsCreateBody', function() {
        // TODO: update the code to test AttachmentsCreateBody
        expect(instance).to.be.a(OutlineApi.AttachmentsCreateBody);
      });
