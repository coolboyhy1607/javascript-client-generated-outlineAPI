...
/**
 * The DocumentsUnpublishBody model module.
 * @module model/DocumentsUnpublishBody
 * @version 0.1.0
 */
export class DocumentsUnpublishBody {
  /**
   * Constructs a new <code>DocumentsUnpublishBody</code>.
   * @alias module:model/DocumentsUnpublishBody
   * @class
  ...
  /**
   * Constructs a <code>DocumentsUnpublishBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocumentsUnpublishBody} obj Optional instance to populate.
   * @return {module:model/DocumentsUnpublishBody} The populated <code>DocumentsUnpublishBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DocumentsUnpublishBody();
 ...
 * @member {String} id
 */
DocumentsUnpublishBody.prototype.id = undefined;
