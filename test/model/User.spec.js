...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('User', function() {
      beforeEach(function() {
        instance = new OutlineApi.User();
      });

      it('should create an instance of User', function() {
        // TODO: update the code to test User
        expect(instance).to.be.a(OutlineApi.User);
      });
      ...
      it('should have the property isSuspended (base name: "isSuspended")', function() {
        // TODO: update the code to test the property isSuspended
        expect(instance).to.have.property('isSuspended');
        // expect(instance.isSuspended).to.be(expectedValueLiteral);
      });

      it('should have the property lastActiveAt (base name: "lastActiveAt")', function() {
        // TODO: update the code to test the property lastActiveAt
        expect(instance).to.have.property('lastActiveAt');
        // expect(instance.lastActiveAt).to.be(expectedValueLiteral);
      });
