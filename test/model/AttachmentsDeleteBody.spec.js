...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AttachmentsDeleteBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.AttachmentsDeleteBody();
      });

      it('should create an instance of AttachmentsDeleteBody', function() {
        // TODO: update the code to test AttachmentsDeleteBody
        expect(instance).to.be.a(OutlineApi.AttachmentsDeleteBody);
      });
