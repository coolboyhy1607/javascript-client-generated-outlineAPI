...
/**
 * The DocumentsExportBody model module.
 * @module model/DocumentsExportBody
 * @version 0.1.0
 */
export class DocumentsExportBody {
  /**
   * Constructs a new <code>DocumentsExportBody</code>.
   * @alias module:model/DocumentsExportBody
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>DocumentsExportBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocumentsExportBody} obj Optional instance to populate.
   * @return {module:model/DocumentsExportBody} The populated <code>DocumentsExportBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DocumentsExportBody();
