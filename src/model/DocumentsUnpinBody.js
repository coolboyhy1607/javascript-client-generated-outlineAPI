...
/**
 * The DocumentsUnpinBody model module.
 * @module model/DocumentsUnpinBody
 * @version 0.1.0
 */
export class DocumentsUnpinBody {
  /**
   * Constructs a new <code>DocumentsUnpinBody</code>.
   * @alias module:model/DocumentsUnpinBody
   * @class
  ...
  /**
   * Constructs a <code>DocumentsUnpinBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocumentsUnpinBody} obj Optional instance to populate.
   * @return {module:model/DocumentsUnpinBody} The populated <code>DocumentsUnpinBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DocumentsUnpinBody();
 ...
 * @member {String} id
 */
DocumentsUnpinBody.prototype.id = undefined;
