...
/**
 * The DocumentsCreateBody model module.
 * @module model/DocumentsCreateBody
 * @version 0.1.0
 */
export class DocumentsCreateBody {
  /**
   * Constructs a new <code>DocumentsCreateBody</code>.
   * @alias module:model/DocumentsCreateBody
   * @class
   * @param title {String} 
   * @param collectionId {String} 
   */
  constructor(title, collectionId) {
    this.title = title;
    this.collectionId = collectionId;
  }

  /**
   * Constructs a <code>DocumentsCreateBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocumentsCreateBody} obj Optional instance to populate.
   * @return {module:model/DocumentsCreateBody} The populated <code>DocumentsCreateBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DocumentsCreateBody();
 ...
 * @member {String} title
 */
DocumentsCreateBody.prototype.title = undefined;

/**
 * The body of the document, may contain markdown formatting.
 * @member {String} text
 */
DocumentsCreateBody.prototype.text = undefined;

/**
 * @member {String} collectionId
 */
DocumentsCreateBody.prototype.collectionId = undefined;

/**
 * @member {String} parentDocumentId
 */
DocumentsCreateBody.prototype.parentDocumentId = undefined;

/**
 * @member {String} templateId
 */
DocumentsCreateBody.prototype.templateId = undefined;

/**
 * Whether this document should be considered to be a template.
 * @member {Boolean} template
 */
DocumentsCreateBody.prototype.template = undefined;

/**
 * Whether this document should be immediately published and made visible to other team members.
 * @member {Boolean} publish
 */
DocumentsCreateBody.prototype.publish = undefined;
