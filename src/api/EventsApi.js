...
export class EventsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the eventsListPost operation.
     * @callback moduleapi/EventsApi~eventsListPostCallback
     ...
     * @param {module:model/EventsListBody} opts.body 
     * @param {module:api/EventsApi~eventsListPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    eventsListPost(opts, callback) {
      opts = opts || {};
