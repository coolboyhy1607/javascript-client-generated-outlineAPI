...
/**
 * The DocumentsListBody model module.
 * @module model/DocumentsListBody
 * @version 0.1.0
 */
export class DocumentsListBody extends Pagination {
  /**
   * Constructs a new <code>DocumentsListBody</code>.
   * @alias module:model/DocumentsListBody
   * @class
  ...
  /**
   * Constructs a <code>DocumentsListBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocumentsListBody} obj Optional instance to populate.
   * @return {module:model/DocumentsListBody} The populated <code>DocumentsListBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DocumentsListBody();
      ...
      if (data.hasOwnProperty('backlinkDocumentId'))
        obj.backlinkDocumentId = ApiClient.convertToType(data['backlinkDocumentId'], 'String');
 ...
 * @member {String} sort
 */
DocumentsListBody.prototype.sort = undefined;
 ...
 * @readonly
 */
DocumentsListBody.DirectionEnum = {
  /**
   * value: "ASC"
   * @const
   */
...
/**
 * @member {module:model/DocumentsListBody.DirectionEnum} direction
 */
DocumentsListBody.prototype.direction = undefined;

/**
 * Optionally filter to a specific collection
 * @member {String} collectionId
 */
DocumentsListBody.prototype.collectionId = undefined;

/**
 * @member {String} userId
 */
DocumentsListBody.prototype.userId = undefined;

/**
 * @member {String} backlinkDocumentId
 */
DocumentsListBody.prototype.backlinkDocumentId = undefined;

/**
 * @member {String} parentDocumentId
 */
DocumentsListBody.prototype.parentDocumentId = undefined;

/**
 * Optionally filter to only templates
 * @member {Boolean} template
 */
DocumentsListBody.prototype.template = undefined;
