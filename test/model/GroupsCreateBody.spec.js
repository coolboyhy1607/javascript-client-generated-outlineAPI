...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GroupsCreateBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.GroupsCreateBody();
      });

      it('should create an instance of GroupsCreateBody', function() {
        // TODO: update the code to test GroupsCreateBody
        expect(instance).to.be.a(OutlineApi.GroupsCreateBody);
      });
