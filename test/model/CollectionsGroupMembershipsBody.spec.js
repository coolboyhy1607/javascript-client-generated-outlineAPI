...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CollectionsGroupMembershipsBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.CollectionsGroupMembershipsBody();
      });

      it('should create an instance of CollectionsGroupMembershipsBody', function() {
        // TODO: update the code to test CollectionsGroupMembershipsBody
        expect(instance).to.be.a(OutlineApi.CollectionsGroupMembershipsBody);
      });
