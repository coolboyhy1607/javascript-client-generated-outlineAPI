...
/**
 * The GroupsRemoveUserBody model module.
 * @module model/GroupsRemoveUserBody
 * @version 0.1.0
 */
export class GroupsRemoveUserBody {
  /**
   * Constructs a new <code>GroupsRemoveUserBody</code>.
   * @alias module:model/GroupsRemoveUserBody
   * @class
  ...
  /**
   * Constructs a <code>GroupsRemoveUserBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GroupsRemoveUserBody} obj Optional instance to populate.
   * @return {module:model/GroupsRemoveUserBody} The populated <code>GroupsRemoveUserBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new GroupsRemoveUserBody();
 ...
 * @member {String} id
 */
GroupsRemoveUserBody.prototype.id = undefined;

/**
 * @member {String} userId
 */
GroupsRemoveUserBody.prototype.userId = undefined;
