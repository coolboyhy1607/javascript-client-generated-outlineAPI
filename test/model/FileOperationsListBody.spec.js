...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FileOperationsListBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.FileOperationsListBody();
      });

      it('should create an instance of FileOperationsListBody', function() {
        // TODO: update the code to test FileOperationsListBody
        expect(instance).to.be.a(OutlineApi.FileOperationsListBody);
      });
