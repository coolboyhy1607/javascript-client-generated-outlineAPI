...
/**
 * The UsersListBody model module.
 * @module model/UsersListBody
 * @version 0.1.0
 */
export class UsersListBody extends Pagination {
  /**
   * Constructs a new <code>UsersListBody</code>.
   * @alias module:model/UsersListBody
   * @class
  ...
  /**
   * Constructs a <code>UsersListBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UsersListBody} obj Optional instance to populate.
   * @return {module:model/UsersListBody} The populated <code>UsersListBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new UsersListBody();
 ...
 * @member {String} sort
 */
UsersListBody.prototype.sort = undefined;
...
/**
 * @member {module:model/UsersListBody.DirectionEnum} direction
 */
UsersListBody.prototype.direction = undefined;

/**
 * @member {String} query
 */
UsersListBody.prototype.query = undefined;
...
/**
 * @member {module:model/UsersListBody.FilterEnum} filter
 */
UsersListBody.prototype.filter = undefined;
