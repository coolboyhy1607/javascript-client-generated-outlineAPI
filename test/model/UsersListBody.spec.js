...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UsersListBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.UsersListBody();
      });

      it('should create an instance of UsersListBody', function() {
        // TODO: update the code to test UsersListBody
        expect(instance).to.be.a(OutlineApi.UsersListBody);
      });
