...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CollectionsCreateBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.CollectionsCreateBody();
      });

      it('should create an instance of CollectionsCreateBody', function() {
        // TODO: update the code to test CollectionsCreateBody
        expect(instance).to.be.a(OutlineApi.CollectionsCreateBody);
      });
