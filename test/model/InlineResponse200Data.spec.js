...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200Data', function() {
      beforeEach(function() {
        instance = new OutlineApi.InlineResponse200Data();
      });

      it('should create an instance of InlineResponse200Data', function() {
        // TODO: update the code to test InlineResponse200Data
        expect(instance).to.be.a(OutlineApi.InlineResponse200Data);
      });

      it('should have the property maxUploadSize (base name: "maxUploadSize")', function() {
        // TODO: update the code to test the property maxUploadSize
        expect(instance).to.have.property('maxUploadSize');
        // expect(instance.maxUploadSize).to.be(expectedValueLiteral);
      });

      it('should have the property uploadUrl (base name: "uploadUrl")', function() {
        // TODO: update the code to test the property uploadUrl
        expect(instance).to.have.property('uploadUrl');
        // expect(instance.uploadUrl).to.be(expectedValueLiteral);
      });
