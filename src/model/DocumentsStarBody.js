...
/**
 * The DocumentsStarBody model module.
 * @module model/DocumentsStarBody
 * @version 0.1.0
 */
export class DocumentsStarBody {
  /**
   * Constructs a new <code>DocumentsStarBody</code>.
   * @alias module:model/DocumentsStarBody
   * @class
  ...
  /**
   * Constructs a <code>DocumentsStarBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocumentsStarBody} obj Optional instance to populate.
   * @return {module:model/DocumentsStarBody} The populated <code>DocumentsStarBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DocumentsStarBody();
 ...
 * @member {String} id
 */
DocumentsStarBody.prototype.id = undefined;
