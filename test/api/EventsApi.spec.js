...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OutlineApi.EventsApi();
  });

  describe('(package)', function() {
    describe('EventsApi', function() {
      describe('eventsListPost', function() {
        it('should call eventsListPost successfully', function(done) {
          // TODO: uncomment, update parameter values for eventsListPost call and complete the assertions
          /*
          var opts = {};

          instance.eventsListPost(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(OutlineApi.InlineResponse20019);
