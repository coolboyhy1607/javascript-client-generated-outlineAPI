...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CollectionsMembershipsBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.CollectionsMembershipsBody();
      });

      it('should create an instance of CollectionsMembershipsBody', function() {
        // TODO: update the code to test CollectionsMembershipsBody
        expect(instance).to.be.a(OutlineApi.CollectionsMembershipsBody);
      });
