...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CollectionsAddGroupBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.CollectionsAddGroupBody();
      });

      it('should create an instance of CollectionsAddGroupBody', function() {
        // TODO: update the code to test CollectionsAddGroupBody
        expect(instance).to.be.a(OutlineApi.CollectionsAddGroupBody);
      });
