...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GroupsUpdateBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.GroupsUpdateBody();
      });

      it('should create an instance of GroupsUpdateBody', function() {
        // TODO: update the code to test GroupsUpdateBody
        expect(instance).to.be.a(OutlineApi.GroupsUpdateBody);
      });
