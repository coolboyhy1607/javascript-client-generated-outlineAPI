...
/**
 * The ViewsCreateBody model module.
 * @module model/ViewsCreateBody
 * @version 0.1.0
 */
export class ViewsCreateBody {
  /**
   * Constructs a new <code>ViewsCreateBody</code>.
   * @alias module:model/ViewsCreateBody
   * @class
  ...
  /**
   * Constructs a <code>ViewsCreateBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ViewsCreateBody} obj Optional instance to populate.
   * @return {module:model/ViewsCreateBody} The populated <code>ViewsCreateBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ViewsCreateBody();
 ...
 */
ViewsCreateBody.prototype.documentId = undefined;
