...
/**
 * The GroupsUpdateBody model module.
 * @module model/GroupsUpdateBody
 * @version 0.1.0
 */
export class GroupsUpdateBody {
  /**
   * Constructs a new <code>GroupsUpdateBody</code>.
   * @alias module:model/GroupsUpdateBody
   * @class
   * @param id {String} 
   * @param name {String} 
   */
  ...
  /**
   * Constructs a <code>GroupsUpdateBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GroupsUpdateBody} obj Optional instance to populate.
   * @return {module:model/GroupsUpdateBody} The populated <code>GroupsUpdateBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new GroupsUpdateBody();
 ...
 * @member {String} id
 */
GroupsUpdateBody.prototype.id = undefined;

/**
 * @member {String} name
 */
GroupsUpdateBody.prototype.name = undefined;
