...
/**
 * The GroupsListBody model module.
 * @module model/GroupsListBody
 * @version 0.1.0
 */
export class GroupsListBody extends Pagination {
  /**
   * Constructs a new <code>GroupsListBody</code>.
   * @alias module:model/GroupsListBody
   * @class
  ...
  /**
   * Constructs a <code>GroupsListBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GroupsListBody} obj Optional instance to populate.
   * @return {module:model/GroupsListBody} The populated <code>GroupsListBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new GroupsListBody();
 ...
 * @member {String} sort
 */
GroupsListBody.prototype.sort = undefined;
...
/**
 * @member {module:model/GroupsListBody.DirectionEnum} direction
 */
GroupsListBody.prototype.direction = undefined;
