...
/**
 * The CollectionsInfoBody model module.
 * @module model/CollectionsInfoBody
 * @version 0.1.0
 */
export class CollectionsInfoBody {
  /**
   * Constructs a new <code>CollectionsInfoBody</code>.
   * @alias module:model/CollectionsInfoBody
   * @class
   * @param id {String} Unique identifier for the collection.
   */
  constructor(id) {
    this.id = id;
  }
  ...
  /**
   * Constructs a <code>CollectionsInfoBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CollectionsInfoBody} obj Optional instance to populate.
   * @return {module:model/CollectionsInfoBody} The populated <code>CollectionsInfoBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CollectionsInfoBody();
 ...
 * @member {String} id
 */
CollectionsInfoBody.prototype.id = undefined;
