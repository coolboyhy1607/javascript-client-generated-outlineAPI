...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CollectionsDeleteBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.CollectionsDeleteBody();
      });

      it('should create an instance of CollectionsDeleteBody', function() {
        // TODO: update the code to test CollectionsDeleteBody
        expect(instance).to.be.a(OutlineApi.CollectionsDeleteBody);
      });
