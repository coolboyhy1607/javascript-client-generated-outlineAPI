...
/**
 * The SharesInfoBody model module.
 * @module model/SharesInfoBody
 * @version 0.1.0
 */
export class SharesInfoBody {
  /**
   * Constructs a new <code>SharesInfoBody</code>.
   * @alias module:model/SharesInfoBody
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>SharesInfoBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SharesInfoBody} obj Optional instance to populate.
   * @return {module:model/SharesInfoBody} The populated <code>SharesInfoBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new SharesInfoBody();
 ...
 * @member {String} id
 */
SharesInfoBody.prototype.id = undefined;

/**
 * Unique identifier for a document. One of id or documentId must be provided.
 * @member {String} documentId
 */
SharesInfoBody.prototype.documentId = undefined;
