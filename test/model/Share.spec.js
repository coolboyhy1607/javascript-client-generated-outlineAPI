...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Share', function() {
      beforeEach(function() {
        instance = new OutlineApi.Share();
      });

      it('should create an instance of Share', function() {
        // TODO: update the code to test Share
        expect(instance).to.be.a(OutlineApi.Share);
      });
      ...
      it('should have the property includeChildDocuments (base name: "includeChildDocuments")', function() {
        // TODO: update the code to test the property includeChildDocuments
        expect(instance).to.have.property('includeChildDocuments');
        // expect(instance.includeChildDocuments).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property lastAccessedAt (base name: "lastAccessedAt")', function() {
        // TODO: update the code to test the property lastAccessedAt
        expect(instance).to.have.property('lastAccessedAt');
        // expect(instance.lastAccessedAt).to.be(expectedValueLiteral);
      });
