...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RevisionsInfoBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.RevisionsInfoBody();
      });

      it('should create an instance of RevisionsInfoBody', function() {
        // TODO: update the code to test RevisionsInfoBody
        expect(instance).to.be.a(OutlineApi.RevisionsInfoBody);
      });
