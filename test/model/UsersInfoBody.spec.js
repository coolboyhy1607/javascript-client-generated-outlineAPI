...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UsersInfoBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.UsersInfoBody();
      });

      it('should create an instance of UsersInfoBody', function() {
        // TODO: update the code to test UsersInfoBody
        expect(instance).to.be.a(OutlineApi.UsersInfoBody);
      });
