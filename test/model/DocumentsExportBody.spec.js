...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentsExportBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.DocumentsExportBody();
      });

      it('should create an instance of DocumentsExportBody', function() {
        // TODO: update the code to test DocumentsExportBody
        expect(instance).to.be.a(OutlineApi.DocumentsExportBody);
      });
      ...
      it('should have the property shareId (base name: "shareId")', function() {
        // TODO: update the code to test the property shareId
        expect(instance).to.have.property('shareId');
        // expect(instance.shareId).to.be(expectedValueLiteral);
      });
