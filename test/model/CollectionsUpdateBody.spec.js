...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CollectionsUpdateBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.CollectionsUpdateBody();
      });

      it('should create an instance of CollectionsUpdateBody', function() {
        // TODO: update the code to test CollectionsUpdateBody
        expect(instance).to.be.a(OutlineApi.CollectionsUpdateBody);
      });
