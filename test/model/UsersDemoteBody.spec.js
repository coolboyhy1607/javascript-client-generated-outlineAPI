...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UsersDemoteBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.UsersDemoteBody();
      });

      it('should create an instance of UsersDemoteBody', function() {
        // TODO: update the code to test UsersDemoteBody
        expect(instance).to.be.a(OutlineApi.UsersDemoteBody);
      });
