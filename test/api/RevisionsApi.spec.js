...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OutlineApi.RevisionsApi();
  });

  describe('(package)', function() {
    describe('RevisionsApi', function() {
      describe('revisionsInfoPost', function() {
        it('should call revisionsInfoPost successfully', function(done) {
          // TODO: uncomment, update parameter values for revisionsInfoPost call and complete the assertions
          /*
          var opts = {};

          instance.revisionsInfoPost(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(OutlineApi.InlineResponse20028);
      ...
      describe('revisionsListPost', function() {
        it('should call revisionsListPost successfully', function(done) {
          // TODO: uncomment, update parameter values for revisionsListPost call and complete the assertions
          /*
          var opts = {};

          instance.revisionsListPost(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(OutlineApi.InlineResponse20029);
