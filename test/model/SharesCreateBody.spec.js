...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SharesCreateBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.SharesCreateBody();
      });

      it('should create an instance of SharesCreateBody', function() {
        // TODO: update the code to test SharesCreateBody
        expect(instance).to.be.a(OutlineApi.SharesCreateBody);
      });
