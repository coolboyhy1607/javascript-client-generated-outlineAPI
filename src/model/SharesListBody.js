...
/**
 * The SharesListBody model module.
 * @module model/SharesListBody
 * @version 0.1.0
 */
export class SharesListBody extends Pagination {
  /**
   * Constructs a new <code>SharesListBody</code>.
   * @alias module:model/SharesListBody
   * @class
  ...
  /**
   * Constructs a <code>SharesListBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SharesListBody} obj Optional instance to populate.
   * @return {module:model/SharesListBody} The populated <code>SharesListBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new SharesListBody();
 ...
 * @member {String} sort
 */
SharesListBody.prototype.sort = undefined;
...
/**
 * @member {module:model/SharesListBody.DirectionEnum} direction
 */
SharesListBody.prototype.direction = undefined;
