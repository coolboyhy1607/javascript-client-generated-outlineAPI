...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CollectionsRemoveUserBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.CollectionsRemoveUserBody();
      });

      it('should create an instance of CollectionsRemoveUserBody', function() {
        // TODO: update the code to test CollectionsRemoveUserBody
        expect(instance).to.be.a(OutlineApi.CollectionsRemoveUserBody);
      });
