...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentsCreateBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.DocumentsCreateBody();
      });

      it('should create an instance of DocumentsCreateBody', function() {
        // TODO: update the code to test DocumentsCreateBody
        expect(instance).to.be.a(OutlineApi.DocumentsCreateBody);
      });
      ...
      it('should have the property publish (base name: "publish")', function() {
        // TODO: update the code to test the property publish
        expect(instance).to.have.property('publish');
        // expect(instance.publish).to.be(expectedValueLiteral);
      });
