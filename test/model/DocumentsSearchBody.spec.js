...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentsSearchBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.DocumentsSearchBody();
      });

      it('should create an instance of DocumentsSearchBody', function() {
        // TODO: update the code to test DocumentsSearchBody
        expect(instance).to.be.a(OutlineApi.DocumentsSearchBody);
      });
      ...
      it('should have the property includeArchived (base name: "includeArchived")', function() {
        // TODO: update the code to test the property includeArchived
        expect(instance).to.have.property('includeArchived');
        // expect(instance.includeArchived).to.be(expectedValueLiteral);
      });

      it('should have the property includeDrafts (base name: "includeDrafts")', function() {
        // TODO: update the code to test the property includeDrafts
        expect(instance).to.have.property('includeDrafts');
        // expect(instance.includeDrafts).to.be(expectedValueLiteral);
      });

      it('should have the property dateFilter (base name: "dateFilter")', function() {
        // TODO: update the code to test the property dateFilter
        expect(instance).to.have.property('dateFilter');
        // expect(instance.dateFilter).to.be(expectedValueLiteral);
      });
