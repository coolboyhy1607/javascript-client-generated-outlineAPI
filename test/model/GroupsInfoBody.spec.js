...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GroupsInfoBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.GroupsInfoBody();
      });

      it('should create an instance of GroupsInfoBody', function() {
        // TODO: update the code to test GroupsInfoBody
        expect(instance).to.be.a(OutlineApi.GroupsInfoBody);
      });
