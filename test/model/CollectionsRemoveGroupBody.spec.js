...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CollectionsRemoveGroupBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.CollectionsRemoveGroupBody();
      });

      it('should create an instance of CollectionsRemoveGroupBody', function() {
        // TODO: update the code to test CollectionsRemoveGroupBody
        expect(instance).to.be.a(OutlineApi.CollectionsRemoveGroupBody);
      });
