...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NavigationNode', function() {
      beforeEach(function() {
        instance = new OutlineApi.NavigationNode();
      });

      it('should create an instance of NavigationNode', function() {
        // TODO: update the code to test NavigationNode
        expect(instance).to.be.a(OutlineApi.NavigationNode);
      });
