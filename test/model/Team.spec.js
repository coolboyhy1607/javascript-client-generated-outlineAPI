...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Team', function() {
      ...
      it('should have the property slackConnected (base name: "slackConnected")', function() {
        // TODO: update the code to test the property slackConnected
        expect(instance).to.have.property('slackConnected');
        // expect(instance.slackConnected).to.be(expectedValueLiteral);
      });

      it('should have the property googleConnected (base name: "googleConnected")', function() {
        // TODO: update the code to test the property googleConnected
        expect(instance).to.have.property('googleConnected');
        // expect(instance.googleConnected).to.be(expectedValueLiteral);
      });

      it('should have the property sharing (base name: "sharing")', function() {
        // TODO: update the code to test the property sharing
        expect(instance).to.have.property('sharing');
        // expect(instance.sharing).to.be(expectedValueLiteral);
      });

      it('should have the property documentEmbeds (base name: "documentEmbeds")', function() {
        // TODO: update the code to test the property documentEmbeds
        expect(instance).to.have.property('documentEmbeds');
        // expect(instance.documentEmbeds).to.be(expectedValueLiteral);
      });

      it('should have the property guestSignin (base name: "guestSignin")', function() {
        // TODO: update the code to test the property guestSignin
        expect(instance).to.have.property('guestSignin');
        // expect(instance.guestSignin).to.be(expectedValueLiteral);
      });
