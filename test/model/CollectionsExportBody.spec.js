...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CollectionsExportBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.CollectionsExportBody();
      });

      it('should create an instance of CollectionsExportBody', function() {
        // TODO: update the code to test CollectionsExportBody
        expect(instance).to.be.a(OutlineApi.CollectionsExportBody);
      });
