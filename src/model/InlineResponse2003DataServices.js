...
/**
 * The InlineResponse2003DataServices model module.
 * @module model/InlineResponse2003DataServices
 * @version 0.1.0
 */
export class InlineResponse2003DataServices {
  /**
   * Constructs a new <code>InlineResponse2003DataServices</code>.
   * @alias module:model/InlineResponse2003DataServices
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>InlineResponse2003DataServices</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2003DataServices} obj Optional instance to populate.
   * @return {module:model/InlineResponse2003DataServices} The populated <code>InlineResponse2003DataServices</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new InlineResponse2003DataServices();
 ...
 * @member {String} id
 */
InlineResponse2003DataServices.prototype.id = undefined;

/**
 * @member {String} name
 */
InlineResponse2003DataServices.prototype.name = undefined;

/**
 * @member {String} authUrl
 */
InlineResponse2003DataServices.prototype.authUrl = undefined;
