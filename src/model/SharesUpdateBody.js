...
/**
 * The SharesUpdateBody model module.
 * @module model/SharesUpdateBody
 * @version 0.1.0
 */
export class SharesUpdateBody {
  /**
   * Constructs a new <code>SharesUpdateBody</code>.
   * @alias module:model/SharesUpdateBody
   * @class
   * @param id {String} 
   * @param published {Boolean} 
   */
  constructor(id, published) {
    this.id = id;
    this.published = published;
  }

  /**
   * Constructs a <code>SharesUpdateBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SharesUpdateBody} obj Optional instance to populate.
   * @return {module:model/SharesUpdateBody} The populated <code>SharesUpdateBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new SharesUpdateBody();
 ...
 * @member {String} id
 */
SharesUpdateBody.prototype.id = undefined;

/**
 * @member {Boolean} published
 */
SharesUpdateBody.prototype.published = undefined;
