...
/**
 * The UsersPromoteBody model module.
 * @module model/UsersPromoteBody
 * @version 0.1.0
 */
export class UsersPromoteBody {
  /**
   * Constructs a new <code>UsersPromoteBody</code>.
   * @alias module:model/UsersPromoteBody
   * @class
  ...
  /**
   * Constructs a <code>UsersPromoteBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UsersPromoteBody} obj Optional instance to populate.
   * @return {module:model/UsersPromoteBody} The populated <code>UsersPromoteBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new UsersPromoteBody();
 ...
 * @member {String} id
 */
UsersPromoteBody.prototype.id = undefined;
