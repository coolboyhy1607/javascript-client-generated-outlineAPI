...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AttachmentsRedirectBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.AttachmentsRedirectBody();
      });

      it('should create an instance of AttachmentsRedirectBody', function() {
        // TODO: update the code to test AttachmentsRedirectBody
        expect(instance).to.be.a(OutlineApi.AttachmentsRedirectBody);
      });
