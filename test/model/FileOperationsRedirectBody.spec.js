...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FileOperationsRedirectBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.FileOperationsRedirectBody();
      });

      it('should create an instance of FileOperationsRedirectBody', function() {
        // TODO: update the code to test FileOperationsRedirectBody
        expect(instance).to.be.a(OutlineApi.FileOperationsRedirectBody);
      });
