...
/**
 * The FileOperationsListBody model module.
 * @module model/FileOperationsListBody
 * @version 0.1.0
 */
export class FileOperationsListBody extends Pagination {
  /**
   * Constructs a new <code>FileOperationsListBody</code>.
   * @alias module:model/FileOperationsListBody
   * @class
   * @extends module:model/Pagination
   * @param type {} The type of fileOperation
   */
  constructor(type) {
    super();
    this.type = type;
  ...
  /**
   * Constructs a <code>FileOperationsListBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FileOperationsListBody} obj Optional instance to populate.
   * @return {module:model/FileOperationsListBody} The populated <code>FileOperationsListBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new FileOperationsListBody();
 ...
 * @member {String} sort
 */
FileOperationsListBody.prototype.sort = undefined;
 ...
 * @readonly
 */
FileOperationsListBody.DirectionEnum = {
  /**
   * value: "ASC"
   * @const
   */
...
/**
 * @member {module:model/FileOperationsListBody.DirectionEnum} direction
 */
FileOperationsListBody.prototype.direction = undefined;
 ...
 * @readonly
 */
FileOperationsListBody.TypeEnum = {
  /**
   * value: "export"
   * @const
   */
 ...
 * @member {module:model/FileOperationsListBody.TypeEnum} type
 */
FileOperationsListBody.prototype.type = undefined;
