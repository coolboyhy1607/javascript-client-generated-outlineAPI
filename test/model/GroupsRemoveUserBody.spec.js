...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GroupsRemoveUserBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.GroupsRemoveUserBody();
      });

      it('should create an instance of GroupsRemoveUserBody', function() {
        // TODO: update the code to test GroupsRemoveUserBody
        expect(instance).to.be.a(OutlineApi.GroupsRemoveUserBody);
      });
