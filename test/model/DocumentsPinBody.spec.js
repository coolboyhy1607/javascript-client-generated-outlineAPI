...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentsPinBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.DocumentsPinBody();
      });

      it('should create an instance of DocumentsPinBody', function() {
        // TODO: update the code to test DocumentsPinBody
        expect(instance).to.be.a(OutlineApi.DocumentsPinBody);
      });
