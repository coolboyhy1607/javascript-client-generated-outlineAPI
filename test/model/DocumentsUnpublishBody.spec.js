...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentsUnpublishBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.DocumentsUnpublishBody();
      });

      it('should create an instance of DocumentsUnpublishBody', function() {
        // TODO: update the code to test DocumentsUnpublishBody
        expect(instance).to.be.a(OutlineApi.DocumentsUnpublishBody);
      });
