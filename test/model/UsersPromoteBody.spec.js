...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UsersPromoteBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.UsersPromoteBody();
      });

      it('should create an instance of UsersPromoteBody', function() {
        // TODO: update the code to test UsersPromoteBody
        expect(instance).to.be.a(OutlineApi.UsersPromoteBody);
      });
