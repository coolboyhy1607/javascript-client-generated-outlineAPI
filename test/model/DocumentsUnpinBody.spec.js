...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentsUnpinBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.DocumentsUnpinBody();
      });

      it('should create an instance of DocumentsUnpinBody', function() {
        // TODO: update the code to test DocumentsUnpinBody
        expect(instance).to.be.a(OutlineApi.DocumentsUnpinBody);
      });
