...
/**
 * The RevisionsListBody model module.
 * @module model/RevisionsListBody
 * @version 0.1.0
 */
export class RevisionsListBody extends Pagination {
  /**
   * Constructs a new <code>RevisionsListBody</code>.
   * @alias module:model/RevisionsListBody
   * @class
  ...
  /**
   * Constructs a <code>RevisionsListBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RevisionsListBody} obj Optional instance to populate.
   * @return {module:model/RevisionsListBody} The populated <code>RevisionsListBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new RevisionsListBody();
 ...
 * @member {String} sort
 */
RevisionsListBody.prototype.sort = undefined;
 ...
 * @readonly
 */
RevisionsListBody.DirectionEnum = {
  /**
   * value: "ASC"
   * @const
   */
...
/**
 * @member {module:model/RevisionsListBody.DirectionEnum} direction
 */
RevisionsListBody.prototype.direction = undefined;
