...
/**
 * The DocumentsSearchBody model module.
 * @module model/DocumentsSearchBody
 * @version 0.1.0
 */
export class DocumentsSearchBody extends Pagination {
  /**
   * Constructs a new <code>DocumentsSearchBody</code>.
   * @alias module:model/DocumentsSearchBody
   * @class
  ...
  /**
   * Constructs a <code>DocumentsSearchBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocumentsSearchBody} obj Optional instance to populate.
   * @return {module:model/DocumentsSearchBody} The populated <code>DocumentsSearchBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DocumentsSearchBody();
      ...
      if (data.hasOwnProperty('includeArchived'))
        obj.includeArchived = ApiClient.convertToType(data['includeArchived'], 'Boolean');
      if (data.hasOwnProperty('includeDrafts'))
        obj.includeDrafts = ApiClient.convertToType(data['includeDrafts'], 'Boolean');
 ...
 * @member {String} query
 */
DocumentsSearchBody.prototype.query = undefined;

/**
 * Any documents that have not been edited by the user identifier will be filtered out
 * @member {String} userId
 */
DocumentsSearchBody.prototype.userId = undefined;

/**
 * A collection to search within
 * @member {String} collectionId
 */
DocumentsSearchBody.prototype.collectionId = undefined;

/**
 * @member {Boolean} includeArchived
 */
DocumentsSearchBody.prototype.includeArchived = undefined;

/**
 * @member {Boolean} includeDrafts
 */
DocumentsSearchBody.prototype.includeDrafts = undefined;
 ...
 * @readonly
 */
DocumentsSearchBody.DateFilterEnum = {
  /**
   * value: "day"
   * @const
   */
 ...
 * @member {module:model/DocumentsSearchBody.DateFilterEnum} dateFilter
 */
DocumentsSearchBody.prototype.dateFilter = undefined;
