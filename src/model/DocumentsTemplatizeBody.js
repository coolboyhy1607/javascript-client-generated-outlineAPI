...
/**
 * The DocumentsTemplatizeBody model module.
 * @module model/DocumentsTemplatizeBody
 * @version 0.1.0
 */
export class DocumentsTemplatizeBody {
  /**
   * Constructs a new <code>DocumentsTemplatizeBody</code>.
   * @alias module:model/DocumentsTemplatizeBody
   * @class
   * @param id {String} 
   */
  constructor(id) {
  ...
  /**
   * Constructs a <code>DocumentsTemplatizeBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocumentsTemplatizeBody} obj Optional instance to populate.
   * @return {module:model/DocumentsTemplatizeBody} The populated <code>DocumentsTemplatizeBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DocumentsTemplatizeBody();
 ...
 * @member {String} id
 */
DocumentsTemplatizeBody.prototype.id = undefined;
