  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('groupMemberships'))
        obj.groupMemberships = ApiClient.convertToType(data['groupMemberships'], [Membership]);
    }
    return obj;
  }
}
 ...
 */
InlineResponse20026Data.prototype.users = undefined;

/**
 * @member {Array.<module:model/Group>} groups
 */
InlineResponse20026Data.prototype.groups = undefined;

/**
 * @member {Array.<module:model/Membership>} groupMemberships
 */
InlineResponse20026Data.prototype.groupMemberships = undefined;
