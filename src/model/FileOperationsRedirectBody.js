...
/**
 * The FileOperationsRedirectBody model module.
 * @module model/FileOperationsRedirectBody
 * @version 0.1.0
 */
export class FileOperationsRedirectBody {
  /**
   * Constructs a new <code>FileOperationsRedirectBody</code>.
   * @alias module:model/FileOperationsRedirectBody
   * @class
   * @param id {String} Unique identifier for the file operation.
   */
  constructor(id) {
    this.id = id;
  }
  ...
  /**
   * Constructs a <code>FileOperationsRedirectBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FileOperationsRedirectBody} obj Optional instance to populate.
   * @return {module:model/FileOperationsRedirectBody} The populated <code>FileOperationsRedirectBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new FileOperationsRedirectBody();
 ...
 * @member {String} id
 */
FileOperationsRedirectBody.prototype.id = undefined;
