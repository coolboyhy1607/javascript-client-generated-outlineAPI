...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UsersUpdateBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.UsersUpdateBody();
      });

      it('should create an instance of UsersUpdateBody', function() {
        // TODO: update the code to test UsersUpdateBody
        expect(instance).to.be.a(OutlineApi.UsersUpdateBody);
      });
