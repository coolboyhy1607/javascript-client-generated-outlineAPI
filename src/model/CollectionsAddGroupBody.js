...
/**
 * The CollectionsAddGroupBody model module.
 * @module model/CollectionsAddGroupBody
 * @version 0.1.0
 */
export class CollectionsAddGroupBody {
  /**
   * Constructs a new <code>CollectionsAddGroupBody</code>.
   * @alias module:model/CollectionsAddGroupBody
   * @class
   * @param id {String} 
  ...
  /**
   * Constructs a <code>CollectionsAddGroupBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CollectionsAddGroupBody} obj Optional instance to populate.
   * @return {module:model/CollectionsAddGroupBody} The populated <code>CollectionsAddGroupBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CollectionsAddGroupBody();
 ...
 * @member {String} id
 */
CollectionsAddGroupBody.prototype.id = undefined;

/**
 * @member {String} groupId
 */
CollectionsAddGroupBody.prototype.groupId = undefined;
