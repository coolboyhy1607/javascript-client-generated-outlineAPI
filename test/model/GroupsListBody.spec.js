...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GroupsListBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.GroupsListBody();
      });

      it('should create an instance of GroupsListBody', function() {
        // TODO: update the code to test GroupsListBody
        expect(instance).to.be.a(OutlineApi.GroupsListBody);
      });
