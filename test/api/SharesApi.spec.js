...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OutlineApi.SharesApi();
  });

  describe('(package)', function() {
    describe('SharesApi', function() {
      describe('sharesCreatePost', function() {
        it('should call sharesCreatePost successfully', function(done) {
          // TODO: uncomment, update parameter values for sharesCreatePost call and complete the assertions
          /*
          var opts = {};

          instance.sharesCreatePost(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(OutlineApi.InlineResponse20030);
      ...
      describe('sharesInfoPost', function() {
        it('should call sharesInfoPost successfully', function(done) {
          // TODO: uncomment, update parameter values for sharesInfoPost call and complete the assertions
          /*
          var opts = {};

          instance.sharesInfoPost(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('sharesListPost', function() {
        it('should call sharesListPost successfully', function(done) {
          // TODO: uncomment, update parameter values for sharesListPost call and complete the assertions
          /*
          var opts = {};

          instance.sharesListPost(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(OutlineApi.InlineResponse20031);
      ...
      describe('sharesRevokePost', function() {
        it('should call sharesRevokePost successfully', function(done) {
          // TODO: uncomment, update parameter values for sharesRevokePost call and complete the assertions
          /*
          var opts = {};

          instance.sharesRevokePost(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('sharesUpdatePost', function() {
        it('should call sharesUpdatePost successfully', function(done) {
          // TODO: uncomment, update parameter values for sharesUpdatePost call and complete the assertions
          /*
          var opts = {};

          instance.sharesUpdatePost(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
