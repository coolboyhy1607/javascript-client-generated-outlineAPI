...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OutlineApi.ViewsApi();
  });

  describe('(package)', function() {
    describe('ViewsApi', function() {
      describe('viewsCreatePost', function() {
        it('should call viewsCreatePost successfully', function(done) {
          // TODO: uncomment, update parameter values for viewsCreatePost call and complete the assertions
          /*
          var opts = {};

          instance.viewsCreatePost(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(OutlineApi.InlineResponse20035);
      ...
      describe('viewsListPost', function() {
        it('should call viewsListPost successfully', function(done) {
          // TODO: uncomment, update parameter values for viewsListPost call and complete the assertions
          /*
          var opts = {};

          instance.viewsListPost(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(OutlineApi.InlineResponse20034);
