...
/**
 * The NavigationNode model module.
 * @module model/NavigationNode
 * @version 0.1.0
 */
export class NavigationNode {
  /**
   * Constructs a new <code>NavigationNode</code>.
   * @alias module:model/NavigationNode
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>NavigationNode</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NavigationNode} obj Optional instance to populate.
   * @return {module:model/NavigationNode} The populated <code>NavigationNode</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new NavigationNode();
      ...
      if (data.hasOwnProperty('children'))
        obj.children = ApiClient.convertToType(data['children'], [NavigationNode]);
    }
    return obj;
  }
}
 ...
 * @member {String} id
 */
NavigationNode.prototype.id = undefined;

/**
 * @member {String} title
 */
NavigationNode.prototype.title = undefined;

/**
 * @member {String} url
 */
NavigationNode.prototype.url = undefined;

/**
 * @member {Array.<module:model/NavigationNode>} children
 */
NavigationNode.prototype.children = undefined;
