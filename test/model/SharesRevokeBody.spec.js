...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SharesRevokeBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.SharesRevokeBody();
      });

      it('should create an instance of SharesRevokeBody', function() {
        // TODO: update the code to test SharesRevokeBody
        expect(instance).to.be.a(OutlineApi.SharesRevokeBody);
      });
