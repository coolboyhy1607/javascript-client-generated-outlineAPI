...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RevisionsListBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.RevisionsListBody();
      });

      it('should create an instance of RevisionsListBody', function() {
        // TODO: update the code to test RevisionsListBody
        expect(instance).to.be.a(OutlineApi.RevisionsListBody);
      });
