...
/**
 * The AttachmentsCreateBody model module.
 * @module model/AttachmentsCreateBody
 * @version 0.1.0
 */
export class AttachmentsCreateBody {
  /**
   * Constructs a new <code>AttachmentsCreateBody</code>.
   * @alias module:model/AttachmentsCreateBody
   * @class
   * @param name {String} 
   * @param contentType {String} 
   * @param size {Number} Size of the file attachment in bytes.
   */
  constructor(name, contentType, size) {
    this.name = name;
  ...
  /**
   * Constructs a <code>AttachmentsCreateBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AttachmentsCreateBody} obj Optional instance to populate.
   * @return {module:model/AttachmentsCreateBody} The populated <code>AttachmentsCreateBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AttachmentsCreateBody();
 ...
 * @member {String} name
 */
AttachmentsCreateBody.prototype.name = undefined;

/**
 * Identifier for the associated document, if any.
 * @member {String} documentId
 */
AttachmentsCreateBody.prototype.documentId = undefined;

/**
 * @member {String} contentType
 */
AttachmentsCreateBody.prototype.contentType = undefined;

/**
 * Size of the file attachment in bytes.
 * @member {Number} size
 */
AttachmentsCreateBody.prototype.size = undefined;
