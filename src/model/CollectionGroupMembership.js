...
/**
 * The CollectionGroupMembership model module.
 * @module model/CollectionGroupMembership
 * @version 0.1.0
 */
export class CollectionGroupMembership {
  /**
   * Constructs a new <code>CollectionGroupMembership</code>.
   * @alias module:model/CollectionGroupMembership
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>CollectionGroupMembership</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CollectionGroupMembership} obj Optional instance to populate.
   * @return {module:model/CollectionGroupMembership} The populated <code>CollectionGroupMembership</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CollectionGroupMembership();
 ...
 * @member {String} id
 */
CollectionGroupMembership.prototype.id = undefined;

/**
 * Identifier for the associated group.
 * @member {String} groupId
 */
CollectionGroupMembership.prototype.groupId = undefined;

/**
 * Identifier for the associated collection.
 * @member {String} collectionId
 */
CollectionGroupMembership.prototype.collectionId = undefined;
 ...
 * @readonly
 */
CollectionGroupMembership.PermissionEnum = {
  /**
   * value: "read"
   * @const
   */
...
/**
 * The permissions that this membership grants the users in the group
 * @member {module:model/CollectionGroupMembership.PermissionEnum} permission
 */
CollectionGroupMembership.prototype.permission = undefined;
