...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20011Data', function() {
      beforeEach(function() {
        instance = new OutlineApi.InlineResponse20011Data();
      });

      it('should create an instance of InlineResponse20011Data', function() {
        // TODO: update the code to test InlineResponse20011Data
        expect(instance).to.be.a(OutlineApi.InlineResponse20011Data);
      });

      it('should have the property fileOperation (base name: "fileOperation")', function() {
        // TODO: update the code to test the property fileOperation
        expect(instance).to.have.property('fileOperation');
        // expect(instance.fileOperation).to.be(expectedValueLiteral);
      });
