...
/**
 * The DocumentsViewedBody model module.
 * @module model/DocumentsViewedBody
 * @version 0.1.0
 */
export class DocumentsViewedBody extends Pagination {
  /**
   * Constructs a new <code>DocumentsViewedBody</code>.
   * @alias module:model/DocumentsViewedBody
   * @class
  ...
  /**
   * Constructs a <code>DocumentsViewedBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocumentsViewedBody} obj Optional instance to populate.
   * @return {module:model/DocumentsViewedBody} The populated <code>DocumentsViewedBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DocumentsViewedBody();
 ...
 * @member {String} sort
 */
DocumentsViewedBody.prototype.sort = undefined;
 ...
 * @readonly
 */
DocumentsViewedBody.DirectionEnum = {
  /**
   * value: "ASC"
   * @const
   */
...
/**
 * @member {module:model/DocumentsViewedBody.DirectionEnum} direction
 */
DocumentsViewedBody.prototype.direction = undefined;
