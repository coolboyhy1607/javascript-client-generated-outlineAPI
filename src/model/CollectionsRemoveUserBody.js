...
/**
 * The CollectionsRemoveUserBody model module.
 * @module model/CollectionsRemoveUserBody
 * @version 0.1.0
 */
export class CollectionsRemoveUserBody {
  /**
   * Constructs a new <code>CollectionsRemoveUserBody</code>.
   * @alias module:model/CollectionsRemoveUserBody
   * @class
  ...
  /**
   * Constructs a <code>CollectionsRemoveUserBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CollectionsRemoveUserBody} obj Optional instance to populate.
   * @return {module:model/CollectionsRemoveUserBody} The populated <code>CollectionsRemoveUserBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CollectionsRemoveUserBody();
 ...
 * @member {String} id
 */
CollectionsRemoveUserBody.prototype.id = undefined;

/**
 * @member {String} userId
 */
CollectionsRemoveUserBody.prototype.userId = undefined;
