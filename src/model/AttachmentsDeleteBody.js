...
/**
 * The AttachmentsDeleteBody model module.
 * @module model/AttachmentsDeleteBody
 * @version 0.1.0
 */
export class AttachmentsDeleteBody {
  /**
   * Constructs a new <code>AttachmentsDeleteBody</code>.
   * @alias module:model/AttachmentsDeleteBody
   * @class
  ...
  /**
   * Constructs a <code>AttachmentsDeleteBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AttachmentsDeleteBody} obj Optional instance to populate.
   * @return {module:model/AttachmentsDeleteBody} The populated <code>AttachmentsDeleteBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AttachmentsDeleteBody();
 ...
 * @member {String} id
 */
AttachmentsDeleteBody.prototype.id = undefined;
