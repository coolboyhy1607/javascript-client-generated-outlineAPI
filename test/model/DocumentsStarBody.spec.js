...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentsStarBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.DocumentsStarBody();
      });

      it('should create an instance of DocumentsStarBody', function() {
        // TODO: update the code to test DocumentsStarBody
        expect(instance).to.be.a(OutlineApi.DocumentsStarBody);
      });
