...
/**
 * The DocumentsInfoBody model module.
 * @module model/DocumentsInfoBody
 * @version 0.1.0
 */
export class DocumentsInfoBody {
  /**
   * Constructs a new <code>DocumentsInfoBody</code>.
   * @alias module:model/DocumentsInfoBody
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>DocumentsInfoBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocumentsInfoBody} obj Optional instance to populate.
   * @return {module:model/DocumentsInfoBody} The populated <code>DocumentsInfoBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DocumentsInfoBody();
