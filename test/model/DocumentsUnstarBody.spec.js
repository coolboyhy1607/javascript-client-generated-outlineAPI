...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentsUnstarBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.DocumentsUnstarBody();
      });

      it('should create an instance of DocumentsUnstarBody', function() {
        // TODO: update the code to test DocumentsUnstarBody
        expect(instance).to.be.a(OutlineApi.DocumentsUnstarBody);
      });
