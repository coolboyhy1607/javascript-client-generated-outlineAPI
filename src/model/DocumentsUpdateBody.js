...
/**
 * The DocumentsUpdateBody model module.
 * @module model/DocumentsUpdateBody
 * @version 0.1.0
 */
export class DocumentsUpdateBody {
  /**
   * Constructs a new <code>DocumentsUpdateBody</code>.
   * @alias module:model/DocumentsUpdateBody
   * @class
   * @param id {String} Unique identifier for the document. Either the UUID or the urlId is acceptable.
   */
  constructor(id) {
    this.id = id;
  }
  ...
  /**
   * Constructs a <code>DocumentsUpdateBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocumentsUpdateBody} obj Optional instance to populate.
   * @return {module:model/DocumentsUpdateBody} The populated <code>DocumentsUpdateBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DocumentsUpdateBody();
 ...
 * @member {String} id
 */
DocumentsUpdateBody.prototype.id = undefined;

/**
 * The title of the document.
 * @member {String} title
 */
DocumentsUpdateBody.prototype.title = undefined;

/**
 * The body of the document, may contain markdown formatting.
 * @member {String} text
 */
DocumentsUpdateBody.prototype.text = undefined;
