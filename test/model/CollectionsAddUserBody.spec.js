...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CollectionsAddUserBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.CollectionsAddUserBody();
      });

      it('should create an instance of CollectionsAddUserBody', function() {
        // TODO: update the code to test CollectionsAddUserBody
        expect(instance).to.be.a(OutlineApi.CollectionsAddUserBody);
      });
