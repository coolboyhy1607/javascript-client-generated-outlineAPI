...
/**
 * The UsersDemoteBody model module.
 * @module model/UsersDemoteBody
 * @version 0.1.0
 */
export class UsersDemoteBody {
  /**
   * Constructs a new <code>UsersDemoteBody</code>.
   * @alias module:model/UsersDemoteBody
   * @class
  ...
  /**
   * Constructs a <code>UsersDemoteBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UsersDemoteBody} obj Optional instance to populate.
   * @return {module:model/UsersDemoteBody} The populated <code>UsersDemoteBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new UsersDemoteBody();
 ...
 * @member {String} id
 */
UsersDemoteBody.prototype.id = undefined;
 ...
 * @member {module:model/UsersDemoteBody.ToEnum} to
 */
UsersDemoteBody.prototype.to = undefined;
