...
/**
 * The AttachmentsRedirectBody model module.
 * @module model/AttachmentsRedirectBody
 * @version 0.1.0
 */
export class AttachmentsRedirectBody {
  /**
   * Constructs a new <code>AttachmentsRedirectBody</code>.
   * @alias module:model/AttachmentsRedirectBody
   * @class
   * @param id {String} Unique identifier for the attachment.
   */
  constructor(id) {
    this.id = id;
  }
  ...
  /**
   * Constructs a <code>AttachmentsRedirectBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AttachmentsRedirectBody} obj Optional instance to populate.
   * @return {module:model/AttachmentsRedirectBody} The populated <code>AttachmentsRedirectBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AttachmentsRedirectBody();
 ...
 * @member {String} id
 */
AttachmentsRedirectBody.prototype.id = undefined;
