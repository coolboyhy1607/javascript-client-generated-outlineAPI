...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentsImportBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.DocumentsImportBody();
      });

      it('should create an instance of DocumentsImportBody', function() {
        // TODO: update the code to test DocumentsImportBody
        expect(instance).to.be.a(OutlineApi.DocumentsImportBody);
      });
