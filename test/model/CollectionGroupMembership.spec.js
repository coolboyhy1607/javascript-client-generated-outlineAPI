...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CollectionGroupMembership', function() {
      beforeEach(function() {
        instance = new OutlineApi.CollectionGroupMembership();
      });

      it('should create an instance of CollectionGroupMembership', function() {
        // TODO: update the code to test CollectionGroupMembership
        expect(instance).to.be.a(OutlineApi.CollectionGroupMembership);
      });
