...
/**
 * The CollectionsDeleteBody model module.
 * @module model/CollectionsDeleteBody
 * @version 0.1.0
 */
export class CollectionsDeleteBody {
  /**
   * Constructs a new <code>CollectionsDeleteBody</code>.
   * @alias module:model/CollectionsDeleteBody
   * @class
   * @param id {String} 
   */
  constructor(id) {
  ...
  /**
   * Constructs a <code>CollectionsDeleteBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CollectionsDeleteBody} obj Optional instance to populate.
   * @return {module:model/CollectionsDeleteBody} The populated <code>CollectionsDeleteBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CollectionsDeleteBody();
 ...
 * @member {String} id
 */
CollectionsDeleteBody.prototype.id = undefined;
