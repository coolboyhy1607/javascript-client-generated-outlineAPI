...
/**
 * The CollectionsRemoveGroupBody model module.
 * @module model/CollectionsRemoveGroupBody
 * @version 0.1.0
 */
export class CollectionsRemoveGroupBody {
  /**
   * Constructs a new <code>CollectionsRemoveGroupBody</code>.
   * @alias module:model/CollectionsRemoveGroupBody
   * @class
   * @param id {String} Identifier for the collection
  ...
  /**
   * Constructs a <code>CollectionsRemoveGroupBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CollectionsRemoveGroupBody} obj Optional instance to populate.
   * @return {module:model/CollectionsRemoveGroupBody} The populated <code>CollectionsRemoveGroupBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CollectionsRemoveGroupBody();
 ...
 * @member {String} id
 */
CollectionsRemoveGroupBody.prototype.id = undefined;

/**
 * @member {String} groupId
 */
CollectionsRemoveGroupBody.prototype.groupId = undefined;
