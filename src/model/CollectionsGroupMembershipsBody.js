...
/**
 * The CollectionsGroupMembershipsBody model module.
 * @module model/CollectionsGroupMembershipsBody
 * @version 0.1.0
 */
export class CollectionsGroupMembershipsBody extends Pagination {
  /**
   * Constructs a new <code>CollectionsGroupMembershipsBody</code>.
   * @alias module:model/CollectionsGroupMembershipsBody
   * @class
  ...
  /**
   * Constructs a <code>CollectionsGroupMembershipsBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CollectionsGroupMembershipsBody} obj Optional instance to populate.
   * @return {module:model/CollectionsGroupMembershipsBody} The populated <code>CollectionsGroupMembershipsBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CollectionsGroupMembershipsBody();
 ...
 * @member {String} id
 */
CollectionsGroupMembershipsBody.prototype.id = undefined;

/**
 * Filter memberships by group names
 * @member {String} query
 */
CollectionsGroupMembershipsBody.prototype.query = undefined;
 ...
 * @readonly
 */
CollectionsGroupMembershipsBody.PermissionEnum = {
  /**
   * value: "read"
   * @const
   */
...
/**
 * Filter memberships by permissions
 * @member {module:model/CollectionsGroupMembershipsBody.PermissionEnum} permission
 */
CollectionsGroupMembershipsBody.prototype.permission = undefined;
