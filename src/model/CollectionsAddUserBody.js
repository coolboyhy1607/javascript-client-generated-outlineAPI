...
/**
 * The CollectionsAddUserBody model module.
 * @module model/CollectionsAddUserBody
 * @version 0.1.0
 */
export class CollectionsAddUserBody {
  /**
   * Constructs a new <code>CollectionsAddUserBody</code>.
   * @alias module:model/CollectionsAddUserBody
   * @class
   * @param id {String} 
   * @param userId {String} 
   */
  ...
  /**
   * Constructs a <code>CollectionsAddUserBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CollectionsAddUserBody} obj Optional instance to populate.
   * @return {module:model/CollectionsAddUserBody} The populated <code>CollectionsAddUserBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CollectionsAddUserBody();
 ...
 * @member {String} id
 */
CollectionsAddUserBody.prototype.id = undefined;

/**
 * @member {String} userId
 */
CollectionsAddUserBody.prototype.userId = undefined;
