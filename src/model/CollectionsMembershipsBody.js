...
/**
 * The CollectionsMembershipsBody model module.
 * @module model/CollectionsMembershipsBody
 * @version 0.1.0
 */
export class CollectionsMembershipsBody extends Pagination {
  /**
   * Constructs a new <code>CollectionsMembershipsBody</code>.
   * @alias module:model/CollectionsMembershipsBody
   * @class
  ...
  /**
   * Constructs a <code>CollectionsMembershipsBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CollectionsMembershipsBody} obj Optional instance to populate.
   * @return {module:model/CollectionsMembershipsBody} The populated <code>CollectionsMembershipsBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CollectionsMembershipsBody();
 ...
 * @member {String} id
 */
CollectionsMembershipsBody.prototype.id = undefined;

/**
 * Filter memberships by user names
 * @member {String} query
 */
CollectionsMembershipsBody.prototype.query = undefined;
 ...
 * @readonly
 */
CollectionsMembershipsBody.PermissionEnum = {
  /**
   * value: "read"
   * @const
   */
 ...
 * @member {module:model/CollectionsMembershipsBody.PermissionEnum} permission
 */
CollectionsMembershipsBody.prototype.permission = undefined;
