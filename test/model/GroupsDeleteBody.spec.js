...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GroupsDeleteBody', function() {
      beforeEach(function() {
        instance = new OutlineApi.GroupsDeleteBody();
      });

      it('should create an instance of GroupsDeleteBody', function() {
        // TODO: update the code to test GroupsDeleteBody
        expect(instance).to.be.a(OutlineApi.GroupsDeleteBody);
      });
