...
/**
 * The DocumentsDeleteBody model module.
 * @module model/DocumentsDeleteBody
 * @version 0.1.0
 */
export class DocumentsDeleteBody {
  /**
   * Constructs a new <code>DocumentsDeleteBody</code>.
   * @alias module:model/DocumentsDeleteBody
   * @class
  ...
  /**
   * Constructs a <code>DocumentsDeleteBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocumentsDeleteBody} obj Optional instance to populate.
   * @return {module:model/DocumentsDeleteBody} The populated <code>DocumentsDeleteBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DocumentsDeleteBody();
 ...
 * @member {String} id
 */
DocumentsDeleteBody.prototype.id = undefined;
 ...
 */
DocumentsDeleteBody.prototype.permanent = undefined;
