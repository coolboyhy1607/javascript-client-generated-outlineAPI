...
/**
 * The GroupsMembershipsBody model module.
 * @module model/GroupsMembershipsBody
 * @version 0.1.0
 */
export class GroupsMembershipsBody extends Pagination {
  /**
   * Constructs a new <code>GroupsMembershipsBody</code>.
   * @alias module:model/GroupsMembershipsBody
   * @class
  ...
  /**
   * Constructs a <code>GroupsMembershipsBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GroupsMembershipsBody} obj Optional instance to populate.
   * @return {module:model/GroupsMembershipsBody} The populated <code>GroupsMembershipsBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new GroupsMembershipsBody();
 ...
 * @member {String} query
 */
GroupsMembershipsBody.prototype.query = undefined;
